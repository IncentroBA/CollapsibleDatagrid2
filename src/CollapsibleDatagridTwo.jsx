...
export function CollapsibleDatagridTwo({ closeOnClick, contentWidgets, displayCompact, openByBoolean, ...rest }) {
    ...
    return (
        <div>
            ...
            <div className={`tr-collapsible ${chevronActive ? "" : "tr-collapsible--collapsed"} ${displayCompact ? 'tr-collapsible--compact' : ''}`} ref={collapsibleRef}>
                {contentWidgets}
            </div>
        </div>
    );
