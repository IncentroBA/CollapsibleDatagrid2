...
export function CollapsibleDatagridTwo({ closeOnClick, contentWidgets, ...rest }) {
    ...
    return (
        <div>
            <div className={`btn-td-collapse ${style} ${isActive ? "btn-td-collapse--active" : ""}`} ref={chevronRef} onClick={toggleTrCollapse}>
            ...
            <div className={`tr-collapsible ${isActive ? "" : "tr-collapsible--collapsed"}`} ref={collapsibleRef}>
                {contentWidgets}
            </div>
        </div>
    );
